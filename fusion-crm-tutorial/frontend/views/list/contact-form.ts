...
export class ContactForm extends View {
    ...
    render() {
        ...
        return html`
            ...
            <vaadin-combo-box label="Status" ${field(model.status)}
                              item-label-path="name" .items="${crmStore.statuses}"></vaadin-combo-box>
            <vaadin-combo-box label="Company" ${field(model.company)}
                              item-label-path="name" .items="${crmStore.companies}"></vaadin-combo-box>
